/**
@module SPECIAL.MODULES.ANALYZE.RUST.ITEM_METRICS
...
*/
// @fileimplements SPECIAL.MODULES.ANALYZE.RUST.ITEM_METRICS
use syn::visit::Visit;
use syn::{BinOp, FnArg, GenericArgument, ImplItemFn, PathArguments, Type, Visibility};
