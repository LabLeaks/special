...
Initializes repo-wide signal accumulation state for architecture metrics before analyzers add concrete repo-wide findings such as duplication and unowned unreached items.
*/
