...
use crate::model::{ModuleDocument, OverviewDocument, RepoDocument, SpecDocument};

use super::projection::{project_document, project_module_document, project_repo_document_json};
...
pub(super) fn render_overview_json(document: &OverviewDocument) -> Result<String> {
    Ok(serde_json::to_string_pretty(document)?)
}
